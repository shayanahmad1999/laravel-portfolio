...
<body class="bg-gray-50 text-gray-800" style="font-family: 'Poppins', sans-serif;">
    ...
    <footer class="mx-auto max-w-6xl px-4 py-12 border-t border-gray-100">
        <div class="grid md:grid-cols-3 gap-8">
            <div>
                <h3 class="font-bold text-xl mb-4 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent inline-block">My Portfolio</h3>
                <p class="text-gray-600 mb-4">A showcase of my work and skills in web development.</p>
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-indigo-600 hover:text-white transition-colors hover-scale">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-600">
                    <li class="flex items-center gap-2"><i class="fas fa-envelope text-indigo-600"></i> contact@example.com</li>
                    <li class="flex items-center gap-2"><i class="fas fa-map-marker-alt text-indigo-600"></i> Your City, Country</li>
                </ul>
            </div>
        </div>
