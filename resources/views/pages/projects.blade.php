    ...
    <div class="fade-in-scroll">
        <div class="mb-12 text-center">
            <h1
                ...
                My Projects</h1>
            <p class="text-gray-600 max-w-2xl mx-auto reveal-text" style="animation-delay: 0.2s">Explore my portfolio of web development projects showcasing my skills in frontend and backend technologies</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-12 fade-in-scroll card-hover-effect"
            ...
            <div class="flex flex-col md:flex-row gap-6 items-end">
                <div class="w-full md:w-1/3">
                    ...
                    <select id="cat" class="form-input bg-white hover-lift rounded-lg border-gray-200 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-all">
                ...
                <div class="w-full md:w-1/3">
                    ...
                    <input id="q" class="form-input hover-lift rounded-lg border-gray-200 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-all" placeholder="Search by title...">
                </div>

                <div class="w-full md:w-auto">
                    <button id="go" class="btn-primary w-full md:w-auto btn-pulse hover-lift px-6 py-3 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium flex items-center justify-center gap-2 transition-all hover:shadow-lg">
    ...
    <script>
      ...
      <article class="project-card rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl card-hover-effect stagger-item" style="transition-delay: ${index * 0.1}s;">
        ${p.thumbnail ? `<div class="relative overflow-hidden h-56">
                      <img src="${p.thumbnail}" class="w-full h-full object-cover img-hover-zoom" alt="${p.title}">
